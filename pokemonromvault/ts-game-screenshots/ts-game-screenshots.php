 ...
 *              Pokemon ROM Vault edition: brand accent #FFCD0A.
 * Version: 4.2
 */
...
function ts_ss_render($atts = []) {
    ...
    $bar_css  = 'display:inline-block;width:4px;height:20px;background:#FFCD0A;border-radius:2px;flex:0 0 4px;';
...
add_action('wp_head', function() {
    ...
    .ts-ss-item:hover{border-color:#FFCD0A !important;box-shadow:0 4px 12px rgba(16,24,40,.12);}
    ...
    .ts-ss-lb-thumb.is-active{opacity:1;border-color:#FFCD0A;}
